...
if __name__ == "__main__":
    ...
    print(args.train)
    # train_data = np.genfromtxt(os.path.join(args.train, "small_fwaf.csv"), skip_header=1)
    #train_data = np.load(os.path.join(args.train, "fwaf_s.npy"))
    train_data = pd.read_csv(os.path.join(args.train, "small_fwaf.csv"))
