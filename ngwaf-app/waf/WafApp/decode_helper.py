...
DECODER_ENDPOINT = "http://decode:3000/magic"

def is_decoder_alive():
    try:
        requests.post(DECODER_ENDPOINT, json={"input": ''})
        return True
...
def decode_payload(payload):
    ...
    decode_text = None
    res = requests.post(DECODER_ENDPOINT, json={"input": payload})
